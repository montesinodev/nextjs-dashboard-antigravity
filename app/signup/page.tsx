  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 sm:p-24 bg-gray-100">
      <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-xl">
        <h1 className="mb-6 text-3xl font-extrabold text-center text-gray-800">Sign Up</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div>
            ...
            <input
              ...
              className="w-full rounded-md border border-gray-300 p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
              value={fullName}
